        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">KSh 1.26M</div>
        ...
        <TabsContent value="payroll" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">KSh {payrollSummary.totalGrossPay.toLocaleString()}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">KSh {payrollSummary.totalPaye.toLocaleString()}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">KSh {payrollSummary.totalNssf.toLocaleString()}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">KSh {payrollSummary.totalSha.toLocaleString()}</div>
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>KSh 1,680,000</TableCell>
                    <TableCell>KSh 420,000</TableCell>
                    <TableCell>KSh 1,260,000</TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell>KSh 1,610,000</TableCell>
                    <TableCell>KSh 402,500</TableCell>
                    <TableCell>KSh 1,207,500</TableCell>
                    <TableCell>
                      <Badge>Processed</Badge>
                    </TableCell>
                    <TableCell>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm">KSh 252,000</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">NSSF Contributions</span>
                    <span className="text-sm">KSh 84,000</span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between border-t pt-2">
                    ...
                    <span className="text-sm font-bold">KSh 420,000</span>
                  </div>
                </div>
              </CardContent>
            </Card>
