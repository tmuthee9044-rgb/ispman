...
import { Activity, Download, RefreshCw, Search, AlertTriangle, Info, AlertCircle, CheckCircle, Shield, Lock, Router, Users, Settings, Eye, Server, Smartphone } from 'lucide-react'
...
const mockLogs: LogEntry[] = [
  ...
  },
  {
    ...
    source: "Airtel Money",
    category: "airtel",
    message: "Payment received: KES 1,200",
    ip_address: "192.168.1.51",
    details: { transaction_id: "AT98765432", customer_id: "5678", amount: 1200 },
  },
  {
    id: "4",
  ...
  },
  {
    ...
    source: "Airtel Money",
    category: "airtel",
    message: "Payment timeout for transaction AT11223344",
    ip_address: "192.168.1.51",
    details: { transaction_id: "AT11223344", timeout_duration: "5min", retry_count: 3 },
  },
]
...
export default function LogsPage() {
  ...
  const categoryStats = {
    ...
    airtel: logs.filter((log) => log.category === "airtel").length,
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Monitor OpenVPN, RADIUS, M-Pesa, Airtel Money, and system activities</p>
        </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="grid w-full grid-cols-4 lg:grid-cols-9">
          ...
          <TabsTrigger value="mpesa">
            <Smartphone className="mr-1 h-3 w-3 text-green-600" />
            M-Pesa ({categoryStats.mpesa})
          </TabsTrigger>
          <TabsTrigger value="airtel">
            <Smartphone className="mr-1 h-3 w-3 text-red-600" />
            Airtel ({categoryStats.airtel})
          </TabsTrigger>
                  ...
                  : activeTab === "openvpn"
                    ...
                    : activeTab === "radius"
                      ...
                      : activeTab === "mpesa"
                        ...
                        : activeTab === "airtel"
                          ? "Airtel Money payment transactions and callbacks"
                          : activeTab === "router"
