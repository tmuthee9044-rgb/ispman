...
export default function CompanySettingsPage() {
  ...
  const handleSave = async (formData: FormData) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success(result.message)
        loadCompanySettings() // Reload settings
      } else {
        toast.error(result.message)
      }
    } catch (error) {
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      defaultValue={companySettings.company_name || "TechConnect ISP"}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      defaultValue={companySettings.company_trading_name || "TechConnect"}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      defaultValue={companySettings.company_registration_number || "RC123456789"}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      defaultValue={companySettings.company_tax_number || "VAT123456789"}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    defaultValue={
                      companySettings.company_description ||
                      "Leading internet service provider offering high-speed connectivity solutions for homes and businesses."
                    }
                    rows={3}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      type="number"
                      placeholder="2020"
                      defaultValue={companySettings.company_founded_year || "2018"}
                    />
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={companySettings.primary_phone || "+254 712 345 678"}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder="+254 700 000 000"
                        defaultValue={companySettings.secondary_phone || "+254 720 987 654"}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={companySettings.primary_email || "info@techconnect.co.ke"}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={companySettings.support_email || "support@techconnect.co.ke"}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={companySettings.website || "https://www.techconnect.co.ke"}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={companySettings.social_facebook || "https://facebook.com/techconnectisp"}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={companySettings.social_twitter || "https://twitter.com/techconnectisp"}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={companySettings.social_linkedin || "https://linkedin.com/company/techconnect"}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={companySettings.street_address || "Westlands Business Park, Block A"}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        name="city"
                        placeholder="City"
                        defaultValue={companySettings.city || "Nairobi"}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={companySettings.state || "Nairobi County"}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        name="postal_code"
                        placeholder="00100"
                        defaultValue={companySettings.postal_code || "00100"}
                      />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="country">Country *</Label>
                      <Select name="country" defaultValue={companySettings.country || "kenya"}>
                        <SelectTrigger>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select name="default_language" defaultValue={companySettings.default_language || "en"}>
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select name="currency" defaultValue={companySettings.currency || "kes"}>
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select name="timezone" defaultValue={companySettings.timezone || "eat"}>
                      <SelectTrigger>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select name="date_format" defaultValue={companySettings.date_format || "dd/mm/yyyy"}>
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select name="time_format" defaultValue={companySettings.time_format || "24h"}>
                      <SelectTrigger>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select name="number_format" defaultValue={companySettings.number_format || "comma"}>
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select name="week_start" defaultValue={companySettings.week_start || "monday"}>
                      <SelectTrigger>
