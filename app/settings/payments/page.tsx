...
import { CreditCard, Smartphone, Building, Webhook, TestTube, Save, AlertCircle, CheckCircle, DollarSign } from 'lucide-react'
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Configure M-Pesa, Airtel Money and other payment processing systems</p>
        </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>Airtel Money Configuration</span>
              </CardTitle>
              <CardDescription>Configure Airtel Money payment integration and paybill settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label className="text-base">Enable Airtel Money Payments</Label>
                  <div className="text-sm text-muted-foreground">Accept payments via Airtel Money API</div>
                </div>
                <Switch defaultChecked />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="airtel-client-id" placeholder="Enter client ID" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="airtel-client-secret">Client Secret *</Label>
                  <Input id="airtel-client-secret" type="password" placeholder="Enter client secret" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="airtel-api-key">API Key *</Label>
                  <Input id="airtel-api-key" type="password" placeholder="Enter API key" />
                </div>
              </div>

              <div className="space-y-4">
                <Label className="text-base">Paybill Configuration</Label>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="airtel-paybill">Paybill Number</Label>
                    <Input id="airtel-paybill" placeholder="123456" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="airtel-account">Account Number</Label>
                    <Input id="airtel-account" placeholder="Enter account number" />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      defaultValue="https://techconnect.co.ke/api/airtel/callback"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      defaultValue="https://techconnect.co.ke/api/airtel/webhook"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="airtel-min-amount">Minimum Amount (KES)</Label>
                    <Input id="airtel-min-amount" type="number" placeholder="10" defaultValue="10" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="airtel-max-amount">Maximum Amount (KES)</Label>
                    <Input id="airtel-max-amount" type="number" placeholder="150000" defaultValue="150000" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="airtel-timeout">Transaction Timeout (seconds)</Label>
                    <Input id="airtel-timeout" type="number" placeholder="300" defaultValue="300" />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <Switch id="airtel-auto-confirm" defaultChecked />
                    <Label htmlFor="airtel-auto-confirm">Auto-confirm transactions</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Switch id="airtel-sms-notifications" defaultChecked />
                    <Label htmlFor="airtel-sms-notifications">Send SMS notifications</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Switch id="airtel-email-receipts" />
                    <Label htmlFor="airtel-email-receipts">Send email receipts</Label>
                  </div>
                </div>
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  defaultValue="Please use your Portal Login ID as the reference when making bank transfers. Transfers may take 1-2 business days to reflect in your account."
                  rows={3}
                />
              </div>
            </CardContent>
                  ...
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">Airtel mobile money</div>
                      </div>
                    </div>
                    <Switch defaultChecked />
                  </div>
