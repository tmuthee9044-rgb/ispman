    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">KSh {stats?.monthly_operating_cost?.toLocaleString() || 0}</div>
                ...
                <TableBody>
                  {filteredVehicles.map((vehicle) => (
                    <TableRow key={vehicle.id}>
                      ...
                      <TableCell>KSh {vehicle.monthly_cost?.toLocaleString()}</TableCell>
                      <TableCell>
                        <div className="flex items-center space-x-2">
                          <Button
                            variant="outline"
        ...
        <TabsContent value="maintenance" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">KSh {stats?.total_maintenance_cost?.toLocaleString() || 0}</div>
        ...
        <TabsContent value="fuel" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">KSh {stats?.total_fuel_cost?.toLocaleString() || 0}</div>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold">KSh {stats?.total_fuel_cost?.toLocaleString() || 0}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Maintenance Costs</span>
                  <span className="font-bold">KSh {stats?.total_maintenance_cost?.toLocaleString() || 0}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Insurance</span>
                ...
                <div className="border-t pt-2">
                  <div className="flex items-center justify-between font-bold">
                    ...
                    <span>KSh {stats?.monthly_operating_cost?.toLocaleString() || 0}</span>
                  </div>
                </div>
              </div>
            </CardContent>
