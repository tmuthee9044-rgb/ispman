...
import { UserPlus, FileText, Network, Settings, AlertTriangle, DollarSign, MessageSquare } from "lucide-react"
...
const systemAlerts = [
  {
    ...
    description: "Network utilization at 89% - consider capacity upgrade",
    severity: "warning",
    time: "5m ago",
    action: "View Details",
  },
  {
    ...
    description: "Router-001 scheduled for maintenance tonight",
    severity: "info",
    time: "1h ago",
    action: "Schedule",
  },
