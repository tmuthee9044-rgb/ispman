...
const helpArticles: HelpArticle[] = [
  ...
  },
  {
    ...
    description: "How to add and manage routers and network devices",
    category: "Network",
    type: "video",
    readTime: "15 min",
    difficulty: "intermediate",
  ...
  },
  {
    ...
    description: "Advanced RADIUS server setup and authentication",
    category: "Network",
    type: "tutorial",
    readTime: "20 min",
    difficulty: "advanced",
...
const categories = [
  ...
  { id: "Network", name: "Network", icon: Network, count: 2 },
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                description: "Setting up routers and network devices",
                duration: "15:22",
                views: "743",
              },
            ].map((video, index) => (
