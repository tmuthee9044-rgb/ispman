          ...
          {payrollSummary && (
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">KSh {payrollSummary.totalNetPay.toLocaleString()}</div>
                    ...
                    {(isCalculated
                      ...
                      return (
                        <TableRow key={isCalculated ? calculation?.employeeId : employee?.employee_id}>
                          ...
                          {isCalculated && (
                            <>
                              <TableCell>KSh {calculation?.paye.toLocaleString()}</TableCell>
                              <TableCell>KSh {calculation?.nssf.toLocaleString()}</TableCell>
                              <TableCell>KSh {calculation?.sha.toLocaleString()}</TableCell>
                              <TableCell className="font-medium">KSh {calculation?.netPay.toLocaleString()}</TableCell>
                            </>
                          )}
                          <TableCell>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm">KSh {payrollSummary.totalPaye.toLocaleString()}</span>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm">KSh {payrollSummary.totalNssf.toLocaleString()}</span>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm">KSh {payrollSummary.totalSha.toLocaleString()}</span>
                    </div>
